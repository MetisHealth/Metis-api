...
public interface UserRepository extends JpaRepository<User, Integer>{
        ...
        List<User> searchUser(@Param("email") String email, @Param("phone") String phone, @Param("name") String name, @Param("doctor") User doctor, @Param("role") Role role, Pageable pageable);
